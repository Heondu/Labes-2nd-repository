    ...
    protected virtual void Execute()
    {
        ...
        foreach (GameObject target in targets)
        {
            ...
            for (int i = 0; i < skill.repeat; i++)
            {
                ...
                StatusCalculator.CalcSkillStatus(new HitData(skillData.executor, skillData.executorStatus, targetEntity, skill, skillData.GetStatus, skillData.GetRelatedStatus, Vector3.zero));
            }
        }
